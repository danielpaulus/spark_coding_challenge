...
class DataBaseLoaderTest {
	...
	@Nested
	class test_with_seed_disabled {
		@BeforeEach
		void setUp() {
			dataBaseLoader = new DataBaseLoader(categoryRepository, questionRepository, surveyRepository, false);
		}
	...
	@Nested
	class test_with_seed_enabled {
		@BeforeEach
		void setUp() {
			dataBaseLoader = new DataBaseLoader(categoryRepository, questionRepository, surveyRepository, true);
		}
